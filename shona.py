...
def mmm(ids,names,passlist):
	...
	try:
		...
		for fikr in passlist:
			...
			if "c_user" in SHONA:
				print('\r\r\033[0;97m[SHONA-CP] %s | %s'%(ids,pas))
	...
	try:
		...
		for fikr in passlist:
			...
			if "c_user" in SHONA:
				...
				if 'y' in pcp:
					print('\r\r\x1b[1;97m[SHONA-CP] '+ids+' | '+pas+'\033[1;97m')
	...
	try:
		for ps in pwx:
			...
			if 'c_user' in log_cookies:
				...
				cid = coki[151:166]
				print('\x1b[1;92m[SHONA-XD-OK] '+cid+' | '+ps+'\033[0;97m')
				...
				coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
				cid = coki[141:156]
				print('\33[38;5;208m[SHONA-XD-CP] '+cid+' | '+ps+'\033[0;92m')
